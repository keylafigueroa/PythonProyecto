...
class Main(QtGui.QMainWindow):
    ...
    def initGui(self):
        ...
        for i in range(9):
            for j in range(9):
                ...
                self.connect(self.casilla[i][j], PyQt4.QtCore.SIGNAL('clicked()'), PyQt4.QtCore.SLOT(self.celdaClicked(i,j)))
        ...
        for i in range(9):
            ...
            self.connect(self.valorPad[i], PyQt4.QtCore.SIGNAL('clicked()'), PyQt4.QtCore.SLOT(self.numeroClicked(i)))
            ...
            if(self.ui.clueButton.isChecked()):
                ...
                for k in range(9):
                    for l in range(9):
                        ...
                        celda.setStyleSheet('background-color: green; font:bold')
    ...
    def validarCelda(self):
        ...
        for i in range(9):
            for j in range(9):
                if(i == self.coorX | j == self.coorY | (i/3 == centerX & j/3 == centerY )):
                    celda = self.casilla[i][j]
                    if (celda.getNumeroAsignado()):
